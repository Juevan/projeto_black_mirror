...
while opcao_escolhida != 0:
    ...
    if opcao_escolhida == 1:
        ...
        if "NOME" in pergunta and "COMPLETO" in pergunta and "PROTAGONISTA" in pergunta and "EPISÓDIO" in pergunta:
            ...
            print(f'PERGUNTA: {pergunta}')
            print('RESPOSTA: É UM COMPUTADOR QUÂNTICO, QUE MAPEIA A VIDA DA JOAN E GERA A SERIE EM CGI')
            ...
            print(f'PERGUNTA: {pergunta}')
            print('RESPOSTA: AO SENTAR NO SOFÁ PARA ASSISTIR SÉRIES COM O SEU NAMORADO, ELA DESCOBRE QUE A PLATAFORMA DE STREAMING STREAMBERRY LANÇOU UMA SÉRIE QUE CONTA SUA VIDA EM TEMPO REAL')
            ...
            print(f'PERGUNTA: {pergunta}')
            print('RESPOSTA: ELA FICOU HORRORISADA AO PERCEBER QUE A SÉRIE MOSTRAVA SUA VIDA, E TENTOU NEGAR TUDO O QUE ACONTECIA NA SÉRIE')
            ...
            print(f'PERGUNTA: {pergunta}')
            print('RESPOSTA: ALGUNS DOS TEMAS ABORDADOS NA SÉRIE DURANTE ESSE EPISÓDIO SÃO: REALIDADE E ILUSÃO, CONTROLE E LIBERDADE, VIGILÂNCIA E PRIVACIDADE, MORALIDADE E ÉTICA, MEMÓRIA E TRAUMA')
        ...
        print("OPÇÃO INVÁLIDA, POR FAVOR TENTE UMA DAS OPÇÕES ABAIXO.")